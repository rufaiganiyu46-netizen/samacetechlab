...
set_flash('error', 'Principal registration is disabled. Only the existing admin account can use the principal portal.');
redirect('principal-login.php');
...
$existingApprovedPrincipal = approved_principal_exists();
...
if (is_post()) {
    ...
    if ($password !== $confirmPassword) {
        ...
        if ($created) {
            if ($existingApprovedPrincipal) {
                set_flash('success', 'Principal registration request submitted. The current principal must approve your account before you can log in.');
            } else {
                set_flash('success', 'Principal account created successfully. Please log in.');
            }
            redirect('principal-login.php');
        }
    }
...
<head>
    ...
    <title>Principal Sign Up | SAMACE TECH LAB</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .orb-teal {
            width: 450px;
            height: 450px;
            background: radial-gradient(circle, rgba(0,212,180,0.09), transparent 70%);
            bottom: -100px;
            right: -100px;
        ...
        .register-card {
            ...
            box-shadow:
                0 0 0 1px rgba(245,166,35,0.07),
        ...
        .register-card::before {
            ...
            right: 0;
            height: 3px;
            background: linear-gradient(90deg, transparent, rgba(245,166,35,0.9) 30%, rgba(0,212,180,0.6) 70%, transparent);
        ...
        .corner-dot.br { bottom:16px; right:16px; background:#F5A623; box-shadow:0 0 10px rgba(245,166,35,0.8); animation-delay:1.5s; }
        ...
        .form-input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(245,166,35,0.12), 0 8px 25px rgba(0,0,0,0.3);
        ...
        .btn-register:hover {
            ...
            box-shadow: 0 0 40px rgba(245,166,35,0.45), 0 12px 30px rgba(0,0,0,0.4);
        }
        ...
        .footer-link.primary { color: #F5A623; font-weight: 600; }
        .footer-link.primary:hover { text-shadow: 0 0 12px rgba(245,166,35,0.5); }
        ...
        .shake { animation: shake 0.5s ease; border-color: #FF4757 !important; }
...
<body class="auth-page" data-role="principal" data-page="signup">
    ...
    <main class="register-wrapper">
        <section class="register-card">
            ...
            <p class="card-subtitle">Register a principal account for secure access to school administration tools.</p>
            ...
            <div class="card-footer-links">
                <a class="footer-link primary" href="principal-login.php">Already have an account?</a>
