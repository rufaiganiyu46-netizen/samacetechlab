...
<head>
    ...
    <title>About Us | SAMACE TECH LAB NURSERY AND PRIMARY SCHOOL</title>
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        h2 { font-size:clamp(1.7rem,4vw,2.5rem); color:var(--primary); margin-bottom:14px; }
        p { line-height:1.75; }
        .hero-box p { color:rgba(255,255,255,.88); max-width:760px; }
        ...
        .list { display:grid; gap:14px; margin-top:18px; color:var(--soft); }
        .pill { display:inline-block; padding:8px 14px; border-radius:999px; background:rgba(245,166,35,.18); color:#704700; font-weight:800; margin-bottom:14px; }
        ...
        .btn.secondary { background:var(--accent); color:#3f2d00; }
    ...
    <main>
        <section class="hero">
            <div class="container hero-box">
                <span class="pill">About Our School</span>
                <h1>Building strong foundations with care, discipline, and technology</h1>
                <p>SAMACE TECH LAB NURSERY AND PRIMARY SCHOOL is a warm and forward-looking learning community in Lagos, Nigeria. We focus on helping children grow academically, socially, and morally in a safe and supportive environment.</p>
            </div>
        </section>
        <section class="section">
            <div class="container grid">
                <article class="card">
                    <h2>Who We Are</h2>
                    <p>We are a child-focused nursery and primary school committed to excellence in teaching, strong values, and practical use of technology in learning. Our classrooms are designed to support curiosity, confidence, and joyful growth.</p>
                    <div class="list">
                        <div>Quality early years and primary education</div>
                        <div>Safe, welcoming, and structured learning spaces</div>
                        <div>Strong partnership with parents and guardians</div>
                        <div>Technology-aware learning for future readiness</div>
                    </div>
                </article>
                <aside class="card">
                    <h2>Our Mission</h2>
                    <p>To raise confident, responsible, and well-prepared learners through excellent teaching, discipline, creativity, and innovation.</p>
                    <div class="actions">
                        <a class="btn primary" href="principal-login.php">Principal Portal</a>
                        <a class="btn secondary" href="index.php#footer">Contact School</a>
                    </div>
                </aside>
            </div>
        </section>
