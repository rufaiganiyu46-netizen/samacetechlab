...
if (is_post()) {
    $user = attempt_login((string) ($_POST['email'] ?? ''), (string) ($_POST['password'] ?? ''), 'parent', $error);

    if ($user) {
        set_flash('success', 'Welcome back, ' . (($user['first_name'] ?? '') ?: ($user['full_name'] ?? 'Parent')) . '.');
...
<head>
    ...
    <title>Parent Login | SAMACE TECH LAB</title>
...
<body class="auth-page" data-role="parent" data-page="login">
    ...
    <main class="login-shell">
        <section class="login-card" id="loginCard">
            ...
            <p class="card-subtitle">Sign in to access parent tools and features.</p>
            ...
            <div class="card-links">
                <a href="parent-signup.php">Create Parent Account</a>
